...
\subsection{Sentence Segmentation}
The rule-based sentence segmentation approach extracted 11,479 sentences from the first 500 documents. Some edge cases like abbreviations and decimal numbers were effectively handled. However, challenges arose in cases with mixed punctuation and lowercase continuations after periods (e.g., "kv. verst").
