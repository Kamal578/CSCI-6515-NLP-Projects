...
\begin{itemize}
    ...
    \item OOV skip example: \texttt{keçmiş:indiki::dünən:bu\_gün}.
\end{itemize}
...
\begin{itemize}
    ...
    \item Coverage ratio on sentiment vocabulary from \texttt{data/external/train.csv}+\texttt{test.csv}
\end{itemize}
...
\begin{itemize}
    \item Expand and curate an Azerbaijani analogy benchmark with stronger OOV control.
    \item Improve sentiment balancing (class weights, sampling, or focal losses).
    \item Add contextual embeddings and transformer baselines for Task 5.
    \item Include error slices by label and confidence calibration in final reporting.
\end{itemize}

\section{Team Contribution}
\begin{itemize}
    \item \textbf{Kamal Ahmadov:} Project 3 pipeline orchestration, Task 1 matrix/statistics implementation, Task 2/3 training integration (Word2Vec/GloVe), Task 5 DL experiment runner, report assembly, and final UI integration.
    \item \textbf{Rufat Guliyev:} Dataset preparation and validation, evaluation criteria review for Tasks 2--5, output verification for comparative tables/figures, presentation preparation, and report review/edits.
    \item \textbf{Shared:} Experiment design decisions, qualitative analysis discussion, and final interpretation of comparative results.
\end{itemize}
